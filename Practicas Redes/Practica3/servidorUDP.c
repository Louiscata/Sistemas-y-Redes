...
int main(int argc, char *argv[])
{
	...
	while (1)
	{
		...
		// Transformamos el mensaje a mayúsculas
		...
		ssize_t bytesEnviados = sendto(propioSocket, mensaje, strlen(mensaje) + 1, 0, (struct sockaddr *)&remoto_addr, sizeof(remoto_addr));
		if (bytesEnviados < 0)
		{
